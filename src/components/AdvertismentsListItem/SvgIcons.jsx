  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M27.677 14.667c0 5.891-4.776 10.667-10.667 13.333-5.891-2.667-10.667-7.442-10.667-13.333s4.776-10.667 10.667-10.667c5.891 0 10.667 4.776 10.667 10.667z"
      ></path>
      <path
        fill="none"
        stroke="#54adff"
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M21.010 14.667c0 2.209-1.791 4-4 4s-4-1.791-4-4c0-2.209 1.791-4 4-4s4 1.791 4 4z"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M17.010 9.333v6.667l4 4M29.010 16c0 6.627-5.373 12-12 12s-12-5.373-12-12c0-6.627 5.373-12 12-12s12 5.373 12 12z"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M17.010 14.667c-3.682 0-6.667 2.985-6.667 6.667s2.985 6.667 6.667 6.667c3.682 0 6.667-2.985 6.667-6.667s-2.985-6.667-6.667-6.667zM17.010 14.667v-10.667M17.010 4l5.333 5.333M17.010 4l-5.333 5.333"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M17.010 17.333c3.682 0 6.667-2.985 6.667-6.667s-2.985-6.667-6.667-6.667c-3.682 0-6.667 2.985-6.667 6.667s2.985 6.667 6.667 6.667zM17.010 17.333v10.667M13.010 24h8"
      ></path>
    </svg>
  );
};
  ...
  return (
    ...
    >
      <path
        ...
        strokeMiterlimit="4"
        strokeWidth="2"
        d="M24 8v16c0 1.473-1.194 2.667-2.667 2.667h-10.667c-1.473 0-2.667-1.194-2.667-2.667v-16M20 8v-1.333c0-1.473-1.194-2.667-2.667-2.667h-2.667c-1.473 0-2.667 1.194-2.667 2.667v1.333M5.333 8h21.333M13.333 13.333v8M18.667 13.333v8"
      ></path>
    </svg>
  );
};
